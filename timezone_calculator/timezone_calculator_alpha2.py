...
#future (fix required)
year_difference_future = year_difference.abs()
years2months_future = years2months.abs()
years2weeks_future = years2weeks_current.abs()
years2days_future = years2days_current.abs()
years2hours_future = years2hours_current.abs()
years2minutes_future = years2minutes_current.abs()
years2seconds_future = years2seconds_current.abs()
...
if current_year < target_year:
    ...
    print(str(years2hours_current) + " Hours, ")
    print(str(years2minutes_current) + " Minutes, ")
    print(str(years2seconds_current) + " Seconds to that date. ")
